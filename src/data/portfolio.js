...
export const projects = [
  ...
  },
  {
    ...
    outcome: 'The complete responsive archive now ships inside this portfolio with story chapters, Rider lineage, film and cast history, source-aware updates and downloadable artwork links.',
    role: 'I shaped the concept, researched the material, designed the visual system, built the React experience, added motion and integrated it directly into the portfolio build.',
    ...
    url: '/ghost-rider/', primaryAction: 'live',
